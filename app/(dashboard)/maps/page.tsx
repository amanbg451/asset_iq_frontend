        ...
        {showPanel && selectedAsset && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-full sm:w-[380px] lg:w-[420px] bg-white dark:bg-gray-900 shadow-2xl z-50 overflow-y-auto"
            >
              <div className="sticky top-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 p-3 lg:p-4 z-10">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-[10px] lg:text-xs text-gray-500 dark:text-gray-400">
                      ID: {selectedAsset.asset_id.substring(0, 12)}...
                    </p>
                  </div>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={handleClosePanel}
                    className="p-1.5 lg:p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
                  >
                    ✕
                  </motion.button>
                </div>
              ...
              <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
                ...
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-950/20 dark:to-red-900/10 rounded-2xl p-4 lg:p-6 border border-red-200/50 dark:border-red-800/30"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`px-2.5 lg:px-3 py-1 lg:py-1.5 rounded-xl text-[10px] lg:text-xs font-semibold ${
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-2xl p-3 lg:p-4 border border-gray-200/50 dark:border-gray-700/50 shadow-sm"
                >
                  <p className="text-[10px] lg:text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
                    📍 Location
                  </p>
                  <p className="text-gray-900 dark:text-white font-mono text-[10px] lg:text-xs">
                ...
                <div className="grid grid-cols-2 gap-2 lg:gap-3">
                  {selectedAsset.serial_number && (
                    <motion.div
                      ...
                      className="bg-white dark:bg-gray-800 rounded-2xl p-3 lg:p-4 border border-gray-200/50 dark:border-gray-700/50 shadow-sm"
                    >
                      <p className="text-[9px] lg:text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                        Serial Number
                      </p>
                      <p className="text-gray-900 dark:text-white font-mono text-[10px] lg:text-xs mt-1">
                        {selectedAsset.serial_number}
                      </p>
                    </motion.div>
                  )}
                  ...
                  {selectedAsset.model && (
                    ...
                    >
                      ...
                      <p className="text-gray-900 dark:text-white font-medium text-[10px] lg:text-xs mt-1">
                        {selectedAsset.model}
                      </p>
                    </motion.div>
                  )}
                  ...
                  {selectedAsset.last_scanned_at && (
                    ...
                    >
                      ...
                      <p className="text-gray-900 dark:text-white text-[10px] lg:text-xs mt-1">
                        {new Date(
                          selectedAsset.last_scanned_at,
                        ).toLocaleString()}
                      </p>
                ...
                <motion.button
                  ...
                  className="w-full mt-2 px-4 lg:px-6 py-2.5 lg:py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:shadow-lg hover:shadow-red-500/30 transition-all duration-300 font-semibold flex items-center justify-center gap-2 text-xs lg:text-sm"
                >
                  View Full Details →
                </motion.button>
              </div>
